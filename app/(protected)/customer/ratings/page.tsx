    ...
    appwriteClient.subscribe(
      ...
      (response: any) => {
        if (
          ...
          setRatings((previousRatings: any[]) => {
            return previousRatings.map((rating: Rating) => {
              return rating.$id === response.payload.$id
                ? response.payload
                : rating;
            });
          });
          ...
          setRatings((previousRatings: any[]) => {
            return previousRatings.filter((raing: Rating) => {
              return raing.$id !== response.payload.$id;
            });
          });
        }
      }
